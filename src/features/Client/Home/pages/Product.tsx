...
export const Product = () => {
  ...
  return (
    <>
      <Header />
      <div>
        <div className="py-10 px-4 flex flex-col gap-4 items-center">
          {/* Galeria de Imagenes */}
          <div className="w-full max-w-96 flex flex-col gap-2">
            <div className="w-full h-96">
              <img
                ...
                className="border-2 border-azul rounded-lg h-96 w-full"
              />
            </div>
          ...
          {/* Datos del Producto */}
          <div className="flex flex-col justify-start w-full text-azul gap-2">
            <p className=" text-2xl font-prosto-one">Codigo 009953</p>
