...
import { useComprasAll } from "../../hooks/Compras/useComprasAll";
import { Loading } from "../../components/Loading";

export const ComprasList = () => {
  const navigate = useNavigate();

  const { data, refetch } = useComprasAll();
  console.log(data);
  ...
  const columns: ColumnDef[] = [
    ...
    {
      accessorKey: "fecha_inicio_vencimiento",
      header: "Fecha Inicio - Vencimiento",
    },
    {
      accessorKey: "estado",
      header: "Estado",
      cell: ({ row }) => {
        ...
        return (
          ...
          >
            {options.estado === "1" ? "Pagado" : "Por pagar"}
          </span>
        );
      },
    },
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex gap-5 items-center">
            <Button
              onClick={() => {
                navigate(`/admin/purchase/${options.id_compra}`);
              }}
            >
              Ver
            </Button>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction
                    onClick={() => handleDeleteUser(options.id_compra)}
                  >
                    Eliminar
                  </AlertDialogAction>
                </AlertDialogFooter>
