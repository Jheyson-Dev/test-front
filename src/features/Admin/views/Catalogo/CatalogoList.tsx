...
// excel
import { ButonExportExcel } from "./ButonExportExcel";
    ...
    <div className="">
      ...
      <div className="flex items-center py-6 justify-between ">
        ...
        <div className="flex gap-2">
          <ButonExportExcel data={data} />
          <Button
            variant={"outline"}
            className="hover:bg-green-500 hover:text-white"
            onClick={() => navigate("/admin/catalog/galeria")}
            // onClick={() => setPdf(true)}
          >
            Exportar pdf Galeria
          </Button>
          <Button
            variant={"outline"}
            className="hover:bg-green-500 hover:text-white"
            onClick={() => navigate("/admin/catalog/tabla")}
            // onClick={() => setPdf(true)}
          >
            Exportar pdf Tabla
          </Button>
